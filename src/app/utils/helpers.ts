...
export function requestIsAllowed(webSocketManager: WebSocketManager, currentController: WSConnection | undefined, controllerToken: string | undefined, jwtToken: string) {
